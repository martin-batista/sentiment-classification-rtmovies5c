...
def main():
    ...
    task.upload_artifact(name='train_data', artifact_object=train_save.to_json(orient='records', lines=True), extension_name='json', wait_on_upload=True)
    task.upload_artifact(name='validation_data', artifact_object=valid_save.to_json(orient='records', lines=True), extension_name='json', wait_on_upload=True)
    task.upload_artifact(name='test_data', artifact_object=test_save.to_json(orient='records', lines=True), extension_name='json', wait_on_upload=True)
